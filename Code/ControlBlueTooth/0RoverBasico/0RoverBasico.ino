...
int x, y;   
byte inByte; // Lect Serial
int LED=13; int MotorOnOff=1;
int i = 1;     // increment
...
TimeInit=millis();
//TimeDif=5000; x=0;  
//while ((millis() - TimeInit) < TimeDif){
//  if (x<12) {Avanza(200); Println("Av");} else {Para();}
//  x++;
//  Println(x);}
//Println(millis() - TimeInit);
//Para();
//Println("Ret");
//Dis=0;
//while (Dis<160){
